...
| Generated reports (PDF) | Participation rates, unaccounted lists | Internal | Retained in activation history alongside the activation itself; access restricted to Administrator and OSH Officer roles, plus whichever named recipients received it by email |
