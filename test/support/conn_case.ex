defmodule SalvorionWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use SalvorionWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use SalvorionWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import SalvorionWeb.ConnCase
    end
  end
